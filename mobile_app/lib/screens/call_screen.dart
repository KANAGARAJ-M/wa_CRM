  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Call Mode', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
      ),
      body: Column(
        children: [
          // Active Call UI
            ...
            child: Column(
              children: [
                ...
                if (_isCallActive) ...[
                  ...
                  const SizedBox(height: 8),
                  const Text('Call in progress...', style: TextStyle(color: Colors.green, fontWeight: FontWeight.w500)),
                ] else ...[
                  const Text(
                    'Ready to call',
                ...
                children: [
                  ...
                  Expanded(
                    child: _isLoadingHistory
                        ...
                        : _history.isEmpty
                            ? Center(child: Text('No history found', style: TextStyle(color: Colors.grey[500])))
                            : ListView.builder(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (call.notes != null && call.notes!.isNotEmpty)
                                          Text(call.notes!, style: const TextStyle(fontSize: 14)),
                                        if (call.product != null && call.product!.isNotEmpty) ...[
                                          ...
                                          Row(
                                            children: [
                                              ...
                                              Text('Product: ${call.product}', style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                                            ],
                                          ),
                                        ],
                                      ],
